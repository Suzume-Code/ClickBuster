    ...
    class CEnemy
    {
        ...
        private void _RandPlace()
        {
            ...
            switch (_intMovePattern)
            {
                case 1:
                    // 画像読み込み
                    _pbImgEnemy.Image = Image.FromFile("images\\enemy1.gif");
                    // 得点
                    _intTokuten = 500;
                    break;
                case 2:
                    // 画像読み込み
                    _pbImgEnemy.Image = Image.FromFile("images\\enemy2.gif");
                    // 得点
                    _intTokuten = 1000;
                    break;
                case 3:
                    // 画像読み込み
                    _pbImgEnemy.Image = Image.FromFile("images\\enemy3.gif");
                    // 得点
                    _intTokuten = 3000;
                    break;
            }
